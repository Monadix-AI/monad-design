...
const edgeObjects = {
  bag: require('@monaddesign/ui/assets/edge-objects/bag.png'),
  brush: require('@monaddesign/ui/assets/edge-objects/brush.png'),
  bulb: require('@monaddesign/ui/assets/edge-objects/bulb.png'),
  calculator: require('@monaddesign/ui/assets/edge-objects/calculator.png'),
  calender: require('@monaddesign/ui/assets/edge-objects/calender.png'),
  can: require('@monaddesign/ui/assets/edge-objects/can.png'),
  camera: require('@monaddesign/ui/assets/edge-objects/camera.png'),
  chess: require('@monaddesign/ui/assets/edge-objects/chess.png'),
  clock: require('@monaddesign/ui/assets/edge-objects/clock.png'),
  'color-palette': require('@monaddesign/ui/assets/edge-objects/color-palette.png'),
  computer: require('@monaddesign/ui/assets/edge-objects/computer.png'),
  glass: require('@monaddesign/ui/assets/edge-objects/glass.png'),
  headphone: require('@monaddesign/ui/assets/edge-objects/headphone.png'),
  key: require('@monaddesign/ui/assets/edge-objects/key.png'),
  laptop: require('@monaddesign/ui/assets/edge-objects/laptop.png'),
  mic: require('@monaddesign/ui/assets/edge-objects/mic.png'),
  mobile: require('@monaddesign/ui/assets/edge-objects/mobile.png'),
  notebook: require('@monaddesign/ui/assets/edge-objects/notebook.png'),
  'paint-kit': require('@monaddesign/ui/assets/edge-objects/paint-kit.png'),
  pencil: require('@monaddesign/ui/assets/edge-objects/pencil.png'),
  picture: require('@monaddesign/ui/assets/edge-objects/picture.png'),
  scissor: require('@monaddesign/ui/assets/edge-objects/scissor.png'),
  'sparkling-water': require('@monaddesign/ui/assets/edge-objects/sparkling-water.png'),
  'takeaway-cup': require('@monaddesign/ui/assets/edge-objects/takeaway-cup.png'),
  'tea-cup': require('@monaddesign/ui/assets/edge-objects/tea-cup.png'),
  travel: require('@monaddesign/ui/assets/edge-objects/travel.png'),
  umbrella: require('@monaddesign/ui/assets/edge-objects/umbrella.png'),
  wallet: require('@monaddesign/ui/assets/edge-objects/wallet.png')
