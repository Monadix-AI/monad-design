...
export const useStyles = createThemedStyles((colors) =>
  StyleSheet.create({
    ...
    brandLetter: { color: colors.onAccent, fontWeight: '900', fontSize: 15 },
    ...
    step: { color: colors.secondaryText, fontSize: 12, letterSpacing: 0.7 },
    setupCard: {
      width: 390,
      padding: 24,
      borderWidth: 1,
    ...
    scanButtonTitle: { color: colors.onAccent, fontSize: 17, fontWeight: '600' },
    scanButtonHint: { color: colors.onAccent, fontSize: 12, marginTop: 2 },
    setupDivider: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 10,
    ...
    codeInput: { fontSize: 22, fontWeight: '800', letterSpacing: 2 },
    ...
    connectText: { color: colors.onAccent, fontSize: 17, fontWeight: '600' },
    securityNote: {
      color: colors.subtle,
      fontSize: 12,
      lineHeight: 15,
    ...
    scanAgainButton: { minWidth: 150, minHeight: 44, borderRadius: 12 },
    scanAgainContent: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    projectRoot: { flex: 1, backgroundColor: 'transparent' },
    projectBody: {
      flex: 1,
      maxWidth: 960,
      width: '100%',
    ...
    pairedText: { color: colors.muted, fontSize: 13 },
    projectList: { flex: 1 },
    ...
    projectMeta: { color: colors.muted, fontSize: 12, marginTop: 5 },
    ...
    pickerRoot: { flex: 1, backgroundColor: 'transparent' },
    pageActions: {
      minHeight: 44,
      marginBottom: 20,
      flexDirection: 'row',
    ...
    backButton: { minHeight: 44, borderRadius: 12 },
    backButtonContent: { paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 7 },
    backButtonLabel: { color: colors.accentText, fontSize: 17 },
    pickerBody: {
      flex: 1,
      maxWidth: 960,
      width: '100%',
    ...
    targetAppCardSelected: { borderColor: colors.accentText },
    targetAppIcon: {
      width: 40,
      height: 40,
      borderRadius: 10,
    ...
    targetAppName: { color: colors.text, fontSize: 13, fontWeight: '700' },
    targetAppBundle: {
      color: colors.accentText,
      fontSize: 12,
      lineHeight: 14,
    ...
    targetAppSelectionSelected: { borderColor: colors.accentText },
    ...
    deviceSkeletonList: { width: '100%' },
    deviceSkeletonCard: { backgroundColor: colors.panelRaised },
    deviceSkeletonGlyph: {
      width: 26,
      height: 46,
      borderRadius: 7,
    ...
    deviceSkeletonDetails: { flex: 1, gap: 9 },
    deviceSkeletonName: {
      width: '80%',
      height: 13,
      borderRadius: 5,
    ...
    deviceSkeletonRuntime: {
      width: '55%',
      height: 9,
      borderRadius: 4,
      backgroundColor: colors.controlSelected
    },
    deviceSkeletonStatus: {
      width: 48,
      height: 8,
      borderRadius: 4,
      backgroundColor: colors.controlSelected
    ...
    deviceRuntime: { color: colors.muted, fontSize: 13, marginTop: 5 },
    ...
    bootedText: { color: colors.muted, fontSize: 12, letterSpacing: 1 },
    connectedText: { color: colors.accentText },
    empty: {
      width: '100%',
      minHeight: 260,
      alignItems: 'center',
    ...
    workspaceRoot: { flex: 1, backgroundColor: colors.canvas },
    ...
    liveText: { color: colors.muted, fontSize: 12, letterSpacing: 1 },
    previewBoundary: { color: colors.warning, fontSize: 12, marginLeft: 10 },
    exitButton: {
      minHeight: 44,
      borderRadius: 12
    },
    ...
    exitText: { color: colors.muted, fontSize: 13 },
    action: {
      minHeight: 44,
      borderRadius: 9,
      marginBottom: 1
    ...
    actionTextActive: { color: colors.onAccent, fontWeight: '800' },
    modeButton: {
      flex: 1,
      minHeight: 44,
      borderRadius: 8
    ...
    canvasSize: { color: colors.muted, fontSize: 12 },
    canvasModeBar: {
      position: 'absolute',
      top: 78,
      left: 18,
    ...
    canvasSelectionTitle: { color: colors.text, fontSize: 13, fontWeight: '800' },
    canvasSelectionMeta: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 3 },
    ...
    canvasControlText: { color: colors.muted, fontSize: 12, fontWeight: '600' },
    zoomControls: {
      position: 'absolute',
      left: 18,
      bottom: 18,
    ...
    canvasErrorText: { flex: 1, color: colors.dangerText, fontSize: 13 },
    ...
    inspectorRuntime: { color: colors.muted, fontSize: 12, marginTop: 3 },
    ...
    inspectorSectionMeta: { color: colors.muted, fontSize: 12 },
    modeSwitch: {
      minHeight: 48,
      padding: 3,
      borderRadius: 11,
