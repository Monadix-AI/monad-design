...
any suggested mitigation. Remove project source, credentials, pairing codes,
tokens, screenshots, and other private data from the report.
...
metadata, and can exchange runtime evidence with a local coding agent. Treat
Core credentials, mobile pairing data, annotated screenshots, and files under
`.monaddesign/` as sensitive local data. Only pair trusted devices on a trusted
network and review source changes before accepting them.
